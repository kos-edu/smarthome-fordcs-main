...
//
public class FordCsMonitorVehicleChargingStateUsers {
	
    // Static variable reference of single_instance
    // of type Singleton
    private static FordCsMonitorVehicleChargingStateUsers single_instance = null;
    ...
    private FordCsMonitorVehicleChargingStateUsers()
    {
    ...
    public static FordCsMonitorVehicleChargingStateUsers getInstance()
    {
        if (single_instance == null) single_instance = new FordCsMonitorVehicleChargingStateUsers();
